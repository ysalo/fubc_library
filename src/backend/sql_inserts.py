...
""" 
def add_author(cursor, first_name, middle_name, last_name):
    try:
        q = ("INSERT INTO Author(first_name, middle_name, last_name) VALUES (%s, %s, %s)")
        cursor.execute(q, (first_name, middle_name, last_name))
        print("Successfully added to Authors Table fist_name = ({}) last_name = ({})".format(first_name, middle_name, last_name))
    except mysql.connector.IntegrityError as err:
...
def add_authored_by(cursor, first_name, middle_name, last_name, title): 
    author_id = get_author_id(cursor, first_name, middle_name, last_name)
...
"""
def add_book(cursor, type_name, barcode, title, first_name, middle_name, last_name, isbn, language, publication_year):
    if type_name == 'book': 
        ...
        add_author(cursor, first_name, middle_name, last_name)
        add_authored_by(cursor, first_name, middle_name, last_name, title)
